...
const tools = [
  ...
  },
  {
    ...
    external: false,
    emoji: '📱',
    label: 'Trail Brew App',
    tag: 'iPhone',
    tagStyle: IN_APP_TAG_STYLE,
    description: 'Find Gauteng trails, make ride plans, and keep every bike ready with service tracking in the Trail Brew app.',
    types: ['Trails', 'Plans', 'Garage'],
    typeColors: ['text-trail-flow', 'text-trail-xc', 'text-trail-enduro'],
    cta: 'Explore the app →',
    active: true,
  },
  {
